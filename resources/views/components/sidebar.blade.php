<div id="sidebar"
    class="fixed inset-y-0 left-0 transform -translate-x-full bg-white shadow-xl w-64 overflow-y-auto transition-transform duration-300 lg:translate-x-0 lg:static lg:inset-0">
