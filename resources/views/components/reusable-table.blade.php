        ...
        <div class="-m-1.5 overflow-x-auto">
            <div class="p-1.5 min-w-full inline-block align-middle">
                <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                    <!-- Header -->
                    <div class="px-4 sm:px-6 py-3 sm:py-4 grid gap-3 md:flex md:items-center md:justify-between border-b border-gray-200">
                        <!-- Title -->
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            @if ($createRoute)
                                <button type="button" 
                                        ...
                                        aria-expanded="false" 
                                        aria-controls="hs-modal-create-product" 
                                        data-hs-overlay="#hs-modal-create-product">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="{{ count($columns) + (!empty($actions) ? 1 : 0) }}"
                                            class="px-4 sm:px-6 py-2 sm:py-3 text-center text-gray-500">
                                            No data available.
                                        </td>
                                    </tr>
                                @endforelse
